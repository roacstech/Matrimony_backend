  ...
  try {
    ...
    const profiles = await db("profiles as p")
      ...
      db.raw("DATE(p.dob) as dob"),
        ...
        "p.grandfather_name",
        "p.grandmother_name",
        "p.mother_side_grandfather_name as motherSideGrandfather",
"p.mother_side_grandmother_name as motherSideGrandmother",
        "p.siblings",
        "p.raasi",
        "p.star",
        "p.dosham",
...
module.exports.updateUserProfile = async (props = {}) => {
  ...
  try {
    ...
    const allowedFields = [
      ...
      "grandfather_name",
      "grandmother_name",
       "mother_side_grandmother_name",
       "mother_side_grandfather_name",
         "workLocation",
      "siblings",
      "raasi",
      "star",
